...
static const char *fonts[] = {
    "Fira Code Nerd Font "
    "Mono:pixelsize=25:antialias=true:autohint=true:style=Retina",
...
ResourcePref resources[] = {
    {"dmenu.color6", STRING, &normfgcolor},
    {"dmenu.color0", STRING, &normbgcolor},
    {"dmenu.color0", STRING, &normhgfgcolor},
    {"dmenu.color6", STRING, &normhgbgcolor},
    {"dmenu.color0", STRING, &selfgcolor},
    {"dmenu.color14", STRING, &selbgcolor},
    {"dmenu.color14", STRING, &selhgfgcolor},
    {"dmenu.color0", STRING, &selhgbgcolor},
};
