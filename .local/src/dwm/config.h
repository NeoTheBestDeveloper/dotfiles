...
static int user_bh            = 36;        /* 0 means that dwm will calculate bar height, >= 1 means dwm will user_bh as bar height */
...
static const char *fonts[] = { 
    "Fira Code Nerd Font Mono:size=11:antialias=true:autohint=true:style=Retina",
