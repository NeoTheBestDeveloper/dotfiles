...
config.set('url.start_pages', 'http://localhost:8888')
config.set('auto_save.session', True)
config.set('editor.command', ["st", "-e", "nvim", "{file}"])
config.set('tabs.title.format_pinned', '{index} {audio}')
config.set(
    'url.searchengines', {
        "DEFAULT": "http://localhost:8888/search?q={}",
        "sx": "http://localhost:8888/search?q={}",
...
config.set('window.title_format', '{perc}{current_title}{title_sep}')
...
config.bind('<Ctrl-Shift-k>', 'scroll up')
